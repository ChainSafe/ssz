...
describe("serialize", () => {
  const testCases: {
    ...
    {value: BigInt(0x01), type: bigint64Type, expected: "0100000000000000"},
    {value: BigInt("0x1000000000000000"), type: bigint64Type, expected: "0000000000000010"},
    {value: BigInt("0xffffffffffffffff"), type: bigint64Type, expected: "ffffffffffffffff"},
    {
      value: BigInt("0xffffffffffffffffffffffffffffffff"),
      type: bigint128Type,
