import {CompositeValue, Json, List} from "../../interface";
...
export class CompositeListStructuralHandler<T extends List<CompositeValue>> extends CompositeArrayStructuralHandler<T> {
