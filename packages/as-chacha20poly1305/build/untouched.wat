(module
 ...
 (data (i32.const 320) "(\00\00\00\01\00\00\00\01\00\00\00(\00\00\00a\00s\00s\00e\00m\00b\00l\00y\00/\00c\00h\00a\00c\00h\00a\002\000\00.\00t\00s\00")
 (table $0 1 funcref)
 ...
 (func $start:assembly/chacha20 (; 8 ;)
 ...
 (func $~lib/typedarray/Int32Array#constructor (; 9 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  if (result i32)
   local.get $0
  else
 ...
 (func $~lib/typedarray/Uint8Array#__get (; 11 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $1
  local.get $0
  i32.load offset=8
  i32.ge_u
 ...
 (func $~lib/typedarray/Uint8Array#__set (; 12 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $1
  local.get $0
  i32.load offset=8
  i32.ge_u
 ...
 (func $assembly/util/writeUint32LE (; 13 ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  local.get $1
  call $~lib/rt/stub/__retain
  local.set $1
  local.get $1
 ...
 (func $~lib/typedarray/Uint8Array#get:length (; 16 ;) (param $0 i32) (result i32)
  local.get $0
  i32.load offset=8
 )
 (func $assembly/util/wipe (; 17 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  call $~lib/rt/stub/__retain
 ...
 (func $assembly/index/streamXORUpdate (; 19 ;) (param $0 i32) (result i32)
  global.get $assembly/index/inputArr
  local.get $0
  global.get $assembly/index/keyArr
  global.get $assembly/index/counterArr
