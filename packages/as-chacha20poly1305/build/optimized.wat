(module
 ...
 (data (i32.const 320) "(\00\00\00\01\00\00\00\01\00\00\00(\00\00\00a\00s\00s\00e\00m\00b\00l\00y\00/\00c\00h\00a\00c\00h\00a\002\000\00.\00t\00s")
 ...
 (func $assembly/util/writeUint32LE (; 9 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $1
  local.get $2
  i32.const 255
  i32.and
 ...
 (func $assembly/chacha20/core (; 10 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $assembly/chacha20/incrementCounter (; 11 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $assembly/util/wipe (; 12 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  local.set $1
  i32.const 0
 ...
 (func $assembly/chacha20/doStreamXORUpdate (; 13 ;) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (result i32)
  (local $5 i32)
  (local $6 i32)
  local.get $0
  local.set $5
 ...
 (func $assembly/index/streamXORUpdate (; 14 ;) (param $0 i32) (result i32)
  global.get $assembly/index/inputArr
  local.get $0
  global.get $assembly/index/keyArr
  global.get $assembly/index/counterArr
