...
const byte = new NumberUintType(1);
const uint8 = new NumberUintType(1);
const uint16 = new NumberUintType(2);
const uint32 = new NumberUintType(4);
const uint64 = new NumberUintType(8);
const uint128 = new NumberUintType(16);
const uint256 = new NumberUintType(32);
...
export function getTestType(testType: string, testCase: string): Type<unknown> {
  switch (testType) {
    ...
    case "uints": {
      // TODO: memoize
      return new NumberUintType(parseSecondNum(testCase, "size") / 8);
    }
