...
import {NumberUintType} from "../../../src/v2/uint";
import {BooleanType} from "../../../src/v2/boolean";

export const Boolean = new BooleanType();
export const Byte = new NumberUintType(1);
...
export const Uint8 = new NumberUintType(1);
export const Uint16 = new NumberUintType(2);
export const Uint32 = new NumberUintType(4);
// TODO
// export const Number64 = new Number64UintType();
export const Number64 = new NumberUintType(8);
// TODO
...
export const Uint64 = new NumberUintType(8);
export const Uint128 = new NumberUintType(16);
export const Uint256 = new NumberUintType(32);
