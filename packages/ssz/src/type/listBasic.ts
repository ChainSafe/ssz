import {LeafNode, Node, Tree, merkleizeInto} from "@chainsafe/persistent-merkle-tree";
import {HashComputationMeta, ValueOf} from "./abstract";
  ...
  implements ArrayBasicType<ElementType>
{
  ...
  commitViewDU(view: ListBasicTreeViewDU<ElementType>, hashComps: HashComputationMeta | null = null): Node {
