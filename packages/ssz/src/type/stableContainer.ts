...
import {CompositeType, ByteViews, CompositeTypeAny, isCompositeType} from "./composite.ts";
import {
...
import {isOptionalType, toNonOptionalType, NonOptionalFields} from "./optional.ts";
