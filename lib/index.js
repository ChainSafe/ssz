...
function sha256(message) {
  // @ts-ignore
  var buf = new Uint8Array(Buffer.from(message));

  var arr = _wasm["default"].__retain(_wasm["default"].__allocArray(_wasm["default"].UINT8ARRAY_ID, buf));

  var pointer = _wasm["default"].hash(arr);

  var result = _wasm["default"].__getArray(pointer);
